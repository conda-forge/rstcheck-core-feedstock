...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/rstcheck-core-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/rstcheck-core-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add rstcheck-core
# for installing globally
pixi global install rstcheck-core
```
...
It is possible to list all of the versions of `rstcheck-core` available on your platform:
...
```
pixi search rstcheck-core --channel conda-forge
```
